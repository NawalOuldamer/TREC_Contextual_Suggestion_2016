...
public class UsersIndex {
	...
	public static void getDocumentTF_IDF() throws IOException{
		FileWriter pw = new FileWriter("indexDocumentUsersTRECCS2016TF-IDF.txt");
	...
	protected static void loadIndex(){
		...
		index = IndexOnDisk.createIndex("/Users/nawalouldamer/MEGAsync/github/TREC_Contextual_Suggestion_2016/index/index_document_users/terrier-4.0/var/index/", "data");
		if(index == null)
		{
